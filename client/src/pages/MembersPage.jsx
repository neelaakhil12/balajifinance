      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-900 text-white text-[11px] font-bold uppercase tracking-wider text-left">
                ...
                members.map((mbr) => (
                  <tr key={mbr.id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="py-3.5 px-4 font-mono text-slate-600">
                      {mbr.masked_aadhaar || 'XXXX-XXXX-XXXX'}
                    </td>
                    <td className="py-3.5 px-4">
                      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                        mbr.kyc_status === 'Verified' || !mbr.kyc_status
